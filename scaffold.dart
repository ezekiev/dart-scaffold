...
93k 12.6k
 Code
 Issues 5,000+
 Pull requests 144  Actions
 Projects 117
 Wiki
 Security 0
 Insights
flutter/packages/flutter/lib/src/material/scaffold.dart
@gspencergoog gspencergoog Add Linux and Windows target platforms (#51519)
1ba4f1f on Mar 3
@abarth @Hixie @HansMuller @a14n @gspencergoog @cbracken @jslavitz @shihaohong @mpcomplete @DaveShuckerow @amirh @rami-a @jonahwilliams @dnfield @brianegan @qchong @goderbauer @filaps @guidezpl @xster @xqwzts @mraleph @tvolkert @5u3it @sethladd @perclasson
2809 lines (2579 sloc)  103 KB
